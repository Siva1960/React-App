  ...
  const loadUsersData = async (
    ...
    switch (optType) {
      case "search":
        ...
        return await axios
          .get(
            `http://localhost:5001/college_data?q=${value}&_start=${start}&_end=${end}`
          )
          .then((response) => {
      ...
      case "filter":
        ...
        return await axios
          .get(
            `http://localhost:5001/college_data?state-province=${filterValue}&_start=${start}&_end=${end}`
          )
          .then((response) => {
            setData(response.data);
      ...
      default:
        ...
        setLoading(true);
        return await axios
          .get(`http://localhost:5001/college_data?_start=${start}&_end=${end}`)
          .then((response) => {
            let state = [];
            setData(response.data);
